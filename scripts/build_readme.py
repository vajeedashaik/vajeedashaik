...
— see generate_terminal.py) and nothing else, per config.yml -> features.
Every other section generator still exists and works standalone; if you
flip a feature back on in config.yml, add its markup block back here.
"""
